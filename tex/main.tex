...
\section{Experiments}
In this section we present our experimental results from applying our algorithms to different types of data. To begin with we will discuss the methodology used to create these results.

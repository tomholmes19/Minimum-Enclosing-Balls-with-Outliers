...
\newcommand{\benchmarkfigurebydata}[3]{
    \benchmarkfigure{alg_benchmarks/by_data/func_n_d30_eta0p9_#1.png}{alg_benchmarks/by_data/func_d_n10000_eta0p9_#1.png}{alg_benchmarks/by_data/func_eta_n10000_d30_#1.png}{#2}{#3}
}
...
\chapter{Experiments}
In this chapter we present our experimental results from applying our algorithms to different types of data.
...
Parameters chosen for $n$ were $n=300$ to $n=750$ in steps of 50. For $d$ we choose $d=2$ to $d=20$ in steps of 2, and for $\eta$ we choose $\eta=0.5$ to $\eta=1$ in steps of 0.05. Note that the $\eta=1$ case reduces to the standard MEB problem.
...
Figure \ref{fig:exact_benchmarks_eta} also produces strange results,
\section{Construction Methods}
\subsection{Methodology}
\subsection{Results}
\subsubsection{By Data Type}
\benchmarkfigurebydata{normal}{Runtimes for each Algorithm on Normal Data}{fig:normal_benchmarks}

\benchmarkfigurebydata{uniform_ball}{Runtimes for each Algorithm on Uniform Ball Data}{fig:uniform_ball_benchmarks}

\benchmarkfigurebydata{hyperspherical_shell}{Runtimes for each Algorithm on Hyperspherical Shell Data}{fig:hyp_shell_benchmarks}

\benchmarkfigurebydata{uniform_ball_with_outliers}{Runtimes for each Algorithm on Uniform Ball with Outiers Data}{fig:unifballwoutliers_benchmarks}
...
\begin{appendices}
    ...
    Here we present all average results for each method, parameter, and data type in tabular form. For each individual result rather than averages, please refer to the \texttt{benchmarks} folder in the Github repository\footnote{\url{https://github.com/tomholmes19/Minimum-Enclosing-Balls-with-Outliers} \cite{Holmes_Minimum_Enclosing_Balls_2021}}.
    
    The tables are organised by data type, and each table contains results for a single varied parameter, with each column a different method.
    
    \subsection{Normal}
    \begin{table}[ht]
        \centering
        \begin{tabular}{|c||c|c|c|c|}\hline
            $n$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            1000&6.3668&7.3439&6.5194&6.3244 \\
            4000&6.5364&7.3344&6.5399&6.3456 \\
            7000&6.746&7.2885&6.5689&6.3491 \\
            10000&6.7353&7.1966&6.499&6.3405 \\
            13000&6.8431&7.1874&6.5052&6.3485 \\
            16000&6.8887&7.2076&6.4883&6.3444 \\
            19000&6.8564&7.1804&6.501&6.3461 \\
            22000&6.962&7.1195&6.4776&6.3416 \\
            25000&6.9262&---&6.4696&6.3382 \\
            28000&6.9413&---&6.4561&6.3463 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        \centering
        \begin{tabular}{|c||c|c|c|c|} \hline
            $d$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            10&4.585&4.1108&4.1228&3.9936 \\
            20&5.788&5.8051&5.4767&5.3263 \\
            30&6.7353&7.1966&6.499&6.3405 \\
            40&7.5588&8.3004&7.3926&7.1958 \\
            50&8.2076&9.4147&8.0895&7.9454 \\
            60&8.8664&10.274&8.8096&8.6194 \\
            70&9.4592&11.2226&9.4445&9.2551 \\
            80&10.0398&11.986&10.0404&9.8288 \\
            90&10.5103&12.7818&10.5329&10.3658 \\
            100&11.079&13.4179&11.0663&10.8786 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        \centering
        \begin{tabular}{|c||c|c|c|c|} \hline
            $\eta$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            0.5&7.0989&6.167&5.5507&5.4123 \\
            0.6&6.8849&6.3643&5.736&5.5898 \\
            0.7&6.6525&6.5807&5.9285&5.7836 \\
            0.8&6.5215&6.8376&6.1598&6.0107 \\
            0.9&6.7353&7.1966&6.499&6.3405 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|c||c|c|c|c|}\hline
            $n$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            1000&0.9952&1.3934&0.9962&0.9968 \\
            4000&0.9961&1.3723&0.9963&0.9963 \\
            7000&0.9963&1.3445&0.9965&0.9965 \\
            10000&0.9963&1.3369&0.9964&0.9964 \\
            13000&0.9962&1.3425&0.9964&0.9963 \\
            16000&0.9964&1.3402&0.9965&0.9964 \\
            19000&0.9964&1.3395&0.9965&0.9964 \\
            22000&0.9964&1.3364&0.9965&0.9964 \\
            25000&0.9964&---&0.9965&0.9964 \\
            28000&0.9964&---&0.9965&0.9965 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|c||c|c|c|c|} \hline
            $d$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            10&0.9893&1.1355&0.9896&0.9895 \\
            20&0.9946&1.2906&0.9947&0.9947 \\
            30&0.9963&1.3369&0.9964&0.9964 \\
            40&0.9972&1.3811&0.9973&0.9973 \\
            50&0.9978&1.3925&0.9978&0.9978 \\
            60&0.9982&1.405&0.9982&0.9982 \\
            70&0.9985&1.4114&0.9985&0.9985 \\
            80&0.9987&1.4238&0.9987&0.9987 \\
            90&0.9989&1.4211&0.9988&0.9988 \\
            100&0.9991&1.43&0.9989&0.9989 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|c||c|c|c|c|} \hline
            $\eta$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            0.5&0.9776&1.2042&0.9771&0.977 \\
            0.6&0.9829&1.2324&0.9831&0.983 \\
            0.7&0.988&1.2612&0.9882&0.9881 \\
            0.8&0.9924&1.2944&0.9926&0.9925 \\
            0.9&0.9963&1.3369&0.9964&0.9964 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|c||c|c|c|c|}\hline
            $n$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            1000&1.9909&2.7798&1.9927&1.9936 \\
            4000&1.9922&2.7317&1.9929&1.9927 \\
            7000&1.9926&2.7088&1.9931&1.9929 \\
            10000&1.9925&2.6711&1.993&1.9927 \\
            13000&1.9928&2.6598&1.9931&1.9929 \\
            16000&1.9928&2.6748&1.993&1.9929 \\
            19000&1.9927&2.6666&1.9929&1.9928 \\
            22000&1.9928&2.6682&1.993&1.9929 \\
            25000&1.9928&---&1.993&1.993 \\
            28000&1.9929&---&1.993&1.993 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|c||c|c|c|c|} \hline
            $d$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            10&1.9791&2.4619&1.9793&1.9792 \\
            20&1.9892&2.5899&1.9895&1.9895 \\
            30&1.9925&2.6711&1.993&1.9927 \\
            40&1.9945&2.7608&1.9948&1.9946 \\
            50&1.9955&2.7855&1.9958&1.9957 \\
            60&1.9963&2.7982&1.9965&1.9964 \\
            70&1.9969&2.8242&1.9971&1.997 \\
            80&1.9972&2.8264&1.9974&1.9974 \\
            90&1.9975&2.8465&1.9977&1.9976 \\
            100&1.9978&2.8579&1.9979&1.9979 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|c||c|c|c|c|} \hline
            $\eta$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            0.5&1.9532&2.4014&1.9538&1.9535 \\
            0.6&1.9658&2.4563&1.9661&1.966 \\
            0.7&1.9759&2.5157&1.9762&1.9762 \\
            0.8&1.9847&2.5802&1.9852&1.985 \\
            0.9&1.9925&2.6711&1.993&1.9927 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|c||c|c|c|c|}\hline
            $n$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            1000&0.999&1.5417&1.088&1.0167 \\
            4000&0.9998&1.4973&1.0245&1.0078 \\
            7000&0.9999&1.5615&1.0123&1.0076 \\
            10000&0.9999&1.5324&1.0107&1.0062 \\
            13000&0.9999&1.5395&1.007&1.0058 \\
            16000&0.9999&1.5545&1.0044&1.0048 \\
            19000&0.9999&1.5311&1.0061&1.0046 \\
            22000&0.9999&1.5454&1.0046&1.0039 \\
            25000&1.0&---&1.004&1.0044 \\
            28000&0.9999&---&1.0036&1.0043 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|c||c|c|c|c|} \hline
            $d$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            10&0.9999&1.3487&1.0101&1.0068 \\
            20&0.9999&1.5107&1.0088&1.0083 \\
            30&0.9999&1.5324&1.0107&1.0062 \\
            40&0.9999&1.5778&1.0097&1.0057 \\
            50&1.0&1.5776&1.012&1.0054 \\
            60&1.0&1.5742&1.011&1.0044 \\
            70&1.0&1.5756&1.0114&1.0041 \\
            80&1.0001&1.5731&1.0111&1.0043 \\
            90&---&1.5695&1.0107&1.0039 \\
            100&---&1.5676&1.0109&1.0034 \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|c||c|c|c|c|} \hline
            $\eta$&RBH&Shenmaier&Shrink Heuristic&Avg. Point Heuristic \\ \hline
            0.5&0.9998&1.5588&1.0016&1.009 \\
            0.6&1.0902&1.5252&1.0021&1.0096 \\
            0.7&0.9999&1.5343&1.0032&1.0083 \\
            0.8&0.9999&1.5307&1.004&1.0074 \\
            0.9&0.9999&1.5324&1.0107&1.0062 \\ \hline
        \end{tabular}

...
\newcommand{\benchmarkfigure}[3]{
    \begin{figure}
        \centering
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{alg_benchmarks/func_n_d30_eta0p9_#1.png}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{alg_benchmarks/func_d_n10000_eta0p9_#1.png}
        \end{subfigure}
        
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{alg_benchmarks/func_eta_n10000_d30_#1.png}
        \end{subfigure}
        \caption{#2}
        \label{#3}
    \end{figure}
...
\benchmarkfigure{normal}{Runtimes for each Algorithm on Normal Data}{fig:normal_benchmarks}

\subsubsection{Uniform Ball}
\benchmarkfigure{uniform_ball}{Runtimes for each Algorithm on Uniform Ball Data}{fig:uniform_ball_benchmarks}

\subsubsection{Hyperspherical Shell}
\benchmarkfigure{hyperspherical_shell}{Runtimes for each Algorithm on Hyperspherical Shell Data}{fig:hyp_shell_benchmarks}

\subsubsection{Uniform Ball with Outliers}
\benchmarkfigure{uniform_ball_with_outliers}{Runtimes for each Algorithm on Uniform Ball with Outiers Data}{fig:unifballwoutliers_benchmarks}

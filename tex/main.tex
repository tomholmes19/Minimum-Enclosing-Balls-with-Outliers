...
\newcommand{\datafigure}[4]{
    ...
    \begin{subfigure}[b]{0.3333\textwidth}
        \centering
        \includegraphics[width=\textwidth]{data_plots/#1}
    \end{subfigure}
    \begin{subfigure}[b]{0.3333\textwidth}
        \centering
        \includegraphics[width=\textwidth]{data_plots/#2}
    \end{subfigure}
    \hfill
    \caption{#3}
    \label{#4}
